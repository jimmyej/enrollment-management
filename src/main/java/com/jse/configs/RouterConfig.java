...
import com.jse.handlers.CourseHandler;
import com.jse.handlers.EnrollmentHandler;
...
public class RouterConfig {
    ...
    @RouterOperations({
            @RouterOperation(
                    ...
                    operation = @Operation(
                            operationId = "signIn",
                            requestBody = @RequestBody(content = @Content(schema = @Schema(implementation = com.jse.security.AuthRequest.class))),
                            responses = {
                                    @ApiResponse(responseCode = "200", description = "Successful authentication", content = @Content(schema = @Schema(implementation = com.jse.security.AuthResponse.class))),
            ...
            @RouterOperation(
                    ...
                    operation = @Operation(
                            operationId = "signUp",
                            requestBody = @RequestBody(content = @Content(schema = @Schema(implementation = com.jse.documents.User.class))),
                            responses = {
                                    @ApiResponse(responseCode = "200", description = "User created", content = @Content(schema = @Schema(implementation = com.jse.documents.User.class))),
